...
silence_threshold = 60  # threshold amplitude for detecting silence; adjust as needed
silent_duration = 5  # Time in seconds before stopping after silence
last_time = time.time()
...
try:
    while True:
        ...
        if avg_amplitude < silence_threshold:
            print(f"Silence detected. Amplitude: {avg_amplitude}")  # Debugging line for silence detection
